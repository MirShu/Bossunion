...
public class MationReviewActivity extends BaseActivity {
    ...
    public int getContentViewId() {
        return R.layout.activity_mation_review;
    }

    @Override
    protected void initAllMembersView(Bundle savedInstanceState) {
        tvMainTitle.setText("评论过我");
        this.bindRecycleView();
    }

    private void bindRecycleView() {
        this.getData();
        this.myOrderReycAdapter = new RecyclerAdapter<DiscoveryList.ListBean>(MationReviewActivity.this, myOrderReycList,
                R.layout.item_mation_review) {
            @Override
            public void convert(RecyclerViewHolder helper, DiscoveryList.ListBean item, int position) {
                ...
                TextView tvReviewContent = helper.getView(R.id.tv_review_content);
                ...
                if (position == 0) {
                    ...
                    tvReviewContent.setText("先见之明呀");
                } else if (position == 4) {
                    tvName.setText("邓琪");
                    tvTime.setText("13分钟前");
                    tvDuty.setText("上海敏俊集团资深HR总监");
                    tvReviewt.setText("失业，论你有多大的资本");
                    tvReviewContent.setText("拖后腿了小伙伴们有木有！！！！！"
                    );
                }
        ...
        this.recyclerView.setLayoutManager(new GridLayoutManager(MationReviewActivity.this, 1, LinearLayoutManager.VERTICAL, false));
        ...
        this.myOrderReycAdapter.setOnItemClickListener((parent, position) -> {
            ...
            UIHelper.startActivity(MationReviewActivity.this, OthersInformationActivity.class, bundle);
        });

    }

    private void getData() {
        RequestParams params = new RequestParams(URLS.MATION_REVIEW);
