...
public class FocuseFrgment extends BaseFragment {
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    LodingDialog lodingDialog;
    private List<NewsModel.DataBean> myOrderReycList = new ArrayList<>();
    private RecyclerAdapter<NewsModel.DataBean> myOrderReycAdapter;
    ...
    private void bindRecycleView() {
        this.getData();
        this.myOrderReycAdapter = new RecyclerAdapter<NewsModel.DataBean>(getActivity(), myOrderReycList,
                R.layout.item_topics_focuse) {
            @Override
            public void convert(RecyclerViewHolder helper, NewsModel.DataBean item, int position) {
                ...
                helper.setImageUrl(R.id.iv_bg, item.getThumbnail_pic_s());
    ...
    private void getData() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                List<NewsModel.DataBean> list;
                NewsModel model = JSON.parseObject(message.getResult(), NewsModel.class);
                model.getData();
                list = model.getData();
